...
class ModelComponentWidget(QtWidgets.QWidget, WidgetUi):
    ...
    def __init__(self, parent=None, item_model=None):
        ...
        self.btn_add.setToolTip(self.tr("Add item"))
        ...
        self.btn_remove.setToolTip(self.tr("Remove item"))
        ...
        self.btn_edit.setToolTip(self.tr("Edit item"))
        self.btn_edit.setEnabled(False)
        self.btn_edit.clicked.connect(self._on_edit_item)

        reload_icon = QgsApplication.instance().getThemeIcon("mActionRefresh.svg")
